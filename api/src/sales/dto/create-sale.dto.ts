...
export class CreateSaleDto {
    ...
    @ApiPropertyOptional({
        description: 'Fecha de la venta (por defecto la fecha actual)',
    ...
    @ApiProperty({
        description: 'Detalles de la venta (mínimo un detalle)',
    ...
    @Type(() => CreateSaleDetailDto)
    @MinLength(1, { message: 'La venta debe tener al menos un detalle' })
